...
public class RunQ2 {
    public static void run() {
        FileHandler2 fileHandlerGeneral = new FileHandler2("App/src/Data/input2.txt", "App/src/Data/outputG2.txt");
        FileHandler2 fileHandlerBinary = new FileHandler2("App/src/Data/input2.txt", "App/src/Data/outputB2.txt");
